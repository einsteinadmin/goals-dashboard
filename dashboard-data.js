const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-09-16T19:05:00-05:00",
    "refreshedBy": "Albert (goal cascade: Anne 9/16 rulings stamped as ruled/awaiting Linda; Cameron rock 3 title + rock 4 status aligned to status.json)",
    "archive": {
      "quarter": "Q2 2026",
    ...
    "statusHistoryStamped": "2026-09-16"
  },
  "network": {
    "phase": "1",
    "phaseLabel": "All 7 COS live — Q3 tracking opens",
    "lastRefreshed": "2026-09-16",
  ...
  "cameronKPIs": [
    {
      ...
      "target": "66%",
      "actual": "9/15 hub: running-truck 35.0% (Sep MTD, pulled 9/15) · trailing-active 81.3% (Q3) · trailing-fleet 66.3% (Q3). Ruler mismatch w/ Matisen still OPEN — not graded vs 66% until settled.",
      "status": "unknown",
    ...
    },
    {
      ...
      "target": "20%",
      "actual": "9/15 hub: 23.1% company (Sep MTD, pulled 9/15) vs 20% target — above bar (was 25.2% on 9/11; MTD moves daily).",
      "status": "green",
    ...
    },
    {
      "name": "Customer NPS",
      "target": "90+",
      "actual": "9/15 hub: Sep MTD 85.8 · Q3 QTD 86.5 (GatherUp direct, pulled 9/15) vs 90+ target — below bar, Red band (<86 monthly).",
      "status": "red",
  ...
  "cameronRocks": [
    {
      ...
      "critical": false,
      "status": "yellow",
      "assessment": "9/11 caveat: Dallas and Garland were the beta branches with ~3 weeks more time in the app, so their on-track % (27, 36) is not a fair benchmark for the other eight — Houston (26%, top in CTXH, not beta) is the cleaner comparison. 9/9: ⚠ HARD NUMBERS LANDED AND THEY ARE NOT GREEN. Branch on-track 9/9 (Mike's pull): Garland 36 · Dallas 27 · Houston 26 · San Antonio 19 · N. Austin 18 · McKinney 18 · Leander 14 · Fort Worth 13 · Tampa 11 · S. Austin 11. Company 19% on track, ~40% counting at-risk (engaging but short on daily signatures). Bar is 70% through stage 4 by EOQ, ~7.5 weeks out. ⭐ RULED 9/9 (Cameron + Brian + Mike, post-huddle): accountability starts at the MANAGER layer, not the mover — Cameron: 'it's bullshit to issue a written warning to a mover when you haven't talked to him about this once.' Sequence: set plan + benchmark + date FIRST (redirect), then if missed the BM gets the warning, then ask that BM whether THEY warned their own FM/ops manager — Cameron does not step through a level. Threshold: a branch under ~50% on-track-or-at-risk signals the management team isn't engaging. Warnings start Fri 9/18. Mike drafts one combined announcement (app changes + accountability) and runs it past Brian before push; Brian is out 9/10-9/11. Mitigations are real but unproven: sprints went free-range (all unlock in stage 4) and Mike says the app is materially easier now — the announcement deliberately pairs 'we made it easier' with 'now we hold you to it.' Honest read: yellow trending red; if 9/18 does not move the on-track number materially, Lane 1 cannot reach the 70% floor by 10/31. ⚠ Confirm with Matisen/Mike that 'on track' (daily-signature pace) maps to the bar's basis (completed through stage 4) — they may not be the same ruler. Prior: 9/4 BM roundtable beta shipped full-cycle; ~63% movers not started entering wk 3.",
      ...
      "goals": [
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/1 sync: G — format RESHAPED to a V1 mockup (async pre-collect win/obstacle/opportunity → Brian moderates the gold, QGR-AAR pattern; small room; beta-test framing). V1 confirmed by end of Wed huddle → FIRST BETA RUN THU 9/3. Leaning: Brian + Mike each run one room, Vera+Gerald consolidate notes.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "9/1 sync: Y — first visit date on the calendar by EOW; last weekend of Sept = Austin (NA or SA Friday). Tags Cameron; possible correlated visit.",
      ...
      "goals": [
        {
          ...
          "ruled": {
            ...
            "awaiting": "Linda",
            "record": "anne-goal-change-2026-09-16.json",
            "green": "Custom claim-submission tool (the Monday intake form counts) built against the OSHA-recordable field spec you hand Matisen before the data structure locks — with a working EE-notification loop confirmed — plus the on-site incident workflow documented and trained to all 10 branch managers, by EOQ.",
            "superGreen": "Green, plus: (a) the mover-specific WC training session built and put in onboarding training; (b) the manager-specific WC training session built and put in onboarding training; (c) at least one real Q3 WC leave case showing correctly in Rippling's leave-tracking view, cross-referenced with FMLA where applicable."
          }
        },
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/16: ruled Green in Anne 1:1 on the Einstein Meeting OS (awaiting Linda). 9/16 sync: Yellow → Green (set live). Engagement-survey app live on a Replit dev server after the working session; not published; no survey launch date set yet. 8/31 (sync): builds with Linda this week (interview → wireframe → Replit); drip-vs-October-blast decision deferred until the tool proves out. | via Linda 8/27: Cameron approved 8/21 building a custom engagement-survey app in-house, replacing the Monday-form platform Anne had flagged administrative/UX frustrations with. Anne's ask (7/14, via Albert) surfaced the platform's history first — Monday form, no vendor, historical results in a Drive folder — then Anne proposed building her own app instead (8/20), matching what the rest of the leadership team has already done. ✅ 8/27 (Cameron 1:1): platform-selection target formally moved to September 15 (from end of August) to give Anne real room to build it herself rather than rush it. Concrete next step assigned: feed this call's transcript to Linda, get a spec sheet drafted, then build/test a prototype directly in Replit — Cameron is deliberately not building it for her so she gets hands-on experience. Anne's own estimate: the week after the 100-point weighting app (~week of 9/8).",
