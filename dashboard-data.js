const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshNote": "7/16 huddle digest. Sales: July trending ~+5% — the number needed to offset June's ~5% miss (hit May sales, missed May revenue); OT weekend push holding. Mike: onboarding tests going INTO mover app (90 Qs split into 4 staged sections) + interactive train-the-trainer sim module; common-mistakes fleet module = last build for build-side SG; PM schedule rebuild in Samsara off DFW hub. Brian: Daniel offer out, South Austin succession opens (Hector/Jesper/Jake Peterson); Scrum training boards + schedule-training rebuild w/ Vera. Anne: lav mic bought — benefits/comp video is the last onboarding-goal piece; BCBS EDI feeds live ~1 wk; engagement survey data cleaned+shared by Fri; eNPS redesign direction = confidential-not-anonymous + voluntary. Frank: decision stands, Brian owes documented level-set within a week. DFWT conduct issue: final warning issued, Anne closing out. No status flips this pass.",
  ...
  "cameronKPIs": [
    ...
    },
    {
      ...
      "target": "20%",
      "actual": "23.6% (Q3-TD, Data Hub, per Matisen 8/17)",
      "status": "green",
  ...
  "cameronRocks": [
    {
      ...
      "critical": false,
      "status": "unknown",
      "assessment": "8/19: Trinity sales class #1 ran 8/18 (class #2 today); Wimp Junction role-play trainer live on Replit v1.1, publish+share to Amanda today; ITP color-code round moved to Fri 8/21. Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
    ...
    },
    {
      ...
      "critical": true,
      "status": "unknown",
      "assessment": "8/19: Brian built a weekly AAR prompt for every CTXH manager's own Claude project (self-reported QG progress → Vera) — the Tier-3 shape; Cameron offered API token + Replit collab for a manager Mission Control (prep flows to Brian + world model). Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
    ...
    },
    {
      ...
      "critical": false,
      "status": "unknown",
      "assessment": "8/19 Mike 1:1: FOUR versions of one thing now exist (Mike's DFWT Command Center [live], Brian's weekly AAR prompt, Matisen's hub, Cameron's Mission Control) — Cameron curating ONE best practice (pulse 12846899618); numbers must reconcile once the hub ships. 8/19 huddle: Matisen has Einstein Games fully automated → Data Hub bundle → QGR packet + branch/company scorecards targeted live by Fri 8/21 (validation pending) — first automated feed into the packet family. Hub gated to Einstein + KP vendor emails (Jeff added). Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
    ...
    {
      "number": 5,
      "name": "Manager Ongoing Education Library (absorbs ECP cert course — one goal)",
      "critical": false,
      "status": "unknown",
      ...
      "superGreen": "Green + financial literacy module (2024 lemonade-stand case) + conflict resolution module (movers + CERs) live, with hospitality + ITP modules spec’d as next-quarter backlog",
  ...
  "leadership": [
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Clark 8/17: 8/17: On track for Green. Super Green (criteria met by 9/15) is a tougher reach. Anne is back in the office tomorrow (8/18) to jumpstart this again. Main blocker is carving out dedicated time with Matisen to work through historicals.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 8/17: 8/17: On track for Green — first financial review meetings (covering July) with managers underway. Need to coordinate with Cameron and Matisen on compiling and integrating the rest of the scorecard for managers to see monthly, not just the financial review — that integration is the main blocker if this is going to reach beyond the financial piece alone.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 8/17: 8/17: Early — haven't made many moves yet. A basic guide for the collections steps is started. No major blockers; should land Green, possibly Super Green.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Clark 8/17: 8/17: Already evaluating one real opportunity out of New York, with multiple more lined up to evaluate. No major blockers. Should land Green, more likely than not to reach Super Green.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 8/17: 8/17: Tampa branch visit scheduled 9/1-9/2, followed by the Moving Titans Conference 9/2 evening through 9/4. Still need to schedule the second (and possibly third) branch visit. No major blockers.",
          "superGreen": "3 visits",
          "green": "2 visits",
          "sourceUpdated": "2026-08-17",
          "source": "cos-feed"
      ...
      "goals": [
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "8/19 1:1: event HQ organized, headcounts done; budget RULED $50–75/head; first BM roundtable wk 2 Sept. via Vera 8/17: Planning scaffolded, execution not started. Project HQ built locally (tools/connection-cadence-hq.html) covering 5 regions, 37 attendees, est. $1,850-2,775 at $50-75/head, Mon-Thu evenings. Live pulse stood up. No event scheduled yet, no roundtable agenda redesigned, no roundtables conducted. Next: build a choice pulse per region group (sports / interactive / comedy) to send out.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "8/19 1:1: scorecard HQ built; 7 to peer review; top = Jake Peterson (grad-degree risk), Jeremy Ecker, Trevor Heath, JT; peer scores due EOD Fri 8/21 → project-phase decision Mon 8/24. via Vera 8/17: Screening is closed and peer review is in flight across all four branches. Seven of eight applicants qualified (Sullivan Lowe screened out on the six-month Lead bar); no further cut was made at this gate — the cover-letter instruction shipped in the messaging but never made it onto the application link, so a weak application score can't be cleanly read as low effort versus a missed instruction. Scoring model rebuilt to weight only evidence-carrying categories: On-Site Evaluations 30, Peer Review 30, Application 25, EMC Games 15, with résumé/tenure/attempts as reference. Games no longer scales down — 10+ on the 1–13 scale is the top score. Application grade now measures the whole written case wherever the candidate made it, with a missing cover letter recorded as a miss but unweighted. Peer evaluation forms built and sent per branch, each naming the South Austin position explicitly; South Austin and Houston ride Training Days 8/19 and 8/20, North Austin is pulsed to Daniel Behseresht with an 80%-response target, Fort Worth sent direct with Mike in the loop. Rationale posted to the live pulse for Cameron and Anne. Projects added as a distinct stage between peer review and interviews. Seats already closed: Daniel Behseresht N. Austin BM (8/10), Hector Zavala S. Austin Ops (8/11), Calvin Hughes to Remote Flex (8/11). Remaining: peer scores, the project stage, interviews, decision, and the documented 30/60/90 the green bar actually requires.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "8/19 1:1: DoD = sandbox 100%; Mike pushes mover enrollment 8/20, Brian confirms CTXH movers on dashboard by Fri 8/21. via Vera 8/17: Manager sandbox training is at 10 of 15 complete as of 8/18 — Rance, Calvin, Chris A., Hector, Frank, Garrison, Dustin, Lukas, Cam K. and Alex T. are through. Daniel B., Nick D., Jespah L. and Joel V. are all expected across the line by the 8/19 deadline. One documented exception: Sergio Buenrostro is out on approved PTO the entire week, and his time off was approved before these completion deadlines were set, so he carries an extended timeline rather than a miss — he completes first thing Monday 8/24. Logged on the live pulse ahead of the deadline rather than after it. With that caveat, 100% of the available manager roster completes by 8/19, keeping Green and Super Green in play. Mover enrollment is not gated on Sergio and proceeds 8/20 as planned. Note the rock is specifically training-camp completion, not general QG accountability.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Vera 8/17: Not started. Requires formal branch audits — scorecard audit + circle-up + huddle audit per location — plus a redesigned branch-visit evaluation dashboard. NOTE: QG meetings and Training Day visits do NOT count toward this goal. Roughly 2.5 months of runway left; needs 3 locations for green, all 5 for super green.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "8/19 1:1: board rebuilt; DoD = invite 15 mgrs + delegation pulse + quiz deadline by Tue/Wed 8/25–26 (CTX first). via Vera 8/17: Rollout infrastructure complete, distribution is the remaining gate. Mock training board trimmed to 32 pulses and expanded with Owner + Definition-of-Done columns for Sky Board parity; duplicated for all 15 CTXH managers (5 BMs + 10 Ops/FM/Flex). Board Fix-It Checklist published. Certifications section built into the SCRUM dashboard to log manager, position, test date, score, grade, and 6-month recert date. Rollout announcement drafted and previewed. Next: invite all 15 managers to their boards, post the real delegation pulse, and start logging recert results.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "8/19 1:1: ALL movers added (Gerald fast-tracked), managers trained, switch flips 8/20; Sergio 8/24 (PTO). Source-of-truth open: Rippling→Monday integration vs EMMA — Cameron confers w/ Matisen before more population. via Gerald 8/17: App is live, introduced to the management team at the QGR, and the quarter tracking dashboard is live. The gating milestone is the 8/19 manager sandbox completion: 9 of 23 managers are done company-wide (Leander and San Antonio at 100%; North Austin, Houston, McKinney, Garland, and Tampa still at zero). Managers started logging in and submitting this week and pressure ramps into the deadline. All active movers enroll 8/20; the ≥70% adoption floor shows no red flags yet but is a real reassess point once movers are in the pipeline after the 20th. Managing to Super Green on the training pipeline (full pipeline / Lead-Ready by 10/19); the Scrum recert piece is carved out to the managers' own Scrum goal, so it isn't graded here.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "8/19 1:1: DFWT Regional Command Center LIVE (2 sync-ups run on it); all 5 field weeks planned — Dallas wk of 8/24 (OT/damages/11 coaching flags), Tampa 9/7–11. via Gerald 8/17: Tracking to Super Green: all 5 field weeks are scheduled starting next week (Green is 3, SG is 5). The enabling infrastructure is already live — the full DFWT command center gives a weekly KPI dashboard + composite score reviewed with the branches each week, which drives focus during each visit and sets priority if things shift mid-quarter. Key-issue logging runs through the Road-to-A+ HQ + command center, so capturing and tracking the 1-issue-per-visit requirement is easy and trackable. The main risk is non-goal workload pulling Mike off the process and out of the field weeks.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "8/19 1:1: NOT red after all — 94 weekly / 91 QTD once Samsara closed; only 4 movers flagged company-wide; chase list done. Samsara Monday-load handoff (Jesper?) gut-check Fri 8/22 (Cameron pushed back). Status flipped red→green on Mike's live correction. via Gerald 8/17: Honest red and an uphill quarter. Company came in at 86 in week 1 — down from last quarter — and this week's score is still being finalized. A structural headwind: Einstein Games is not live this quarter, removing the main lever that kept the team engaged on safety. The restructure centers on the warning chase, and this is the first week the chase list is being confirmed — whether last week's required warnings were actually issued in Rippling lands today or tomorrow, so chase effectiveness is still unproven. Mike's honest read: this is a fight all quarter to reach Green (≥90 by Oct 1 + zero warning backlog), let alone Super Green.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "8/19 1:1: NOT red after all — 94 weekly / 91 QTD once Samsara closed; only 4 movers flagged company-wide; chase list done. Samsara Monday-load handoff (Jesper?) gut-check Fri 8/22 (Cameron pushed back). Status flipped red→green on Mike's live correction. via Gerald 8/17: Aiming to sell all 5 but managing to the Green line of 3. Path to the first sale: the NWT truck is prepped and spoken for, blocked on a check-engine fix that's being worked now; the rest need good photos, then they get posted to Facebook Marketplace to gauge engagement. No buyer-side deadline pressure — Oct 31 (EOQ) is the only clock. Funds the 2026 fleet purchases.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "red",
          "assessment": "8/21: Mike starting the first manager training module; still the only Red on the Q3 board. Mover/manager onboarding continuing (recurring friction = non-linked emails). Ian Ives gamed the Leander training booklet with junk photos — denial reasons now logged on rejection, Frank coaches, Cameron follows up in a week. 8/19 1:1: HQ up, 5 green-band modules chosen; SG add-ons hiring/circle-ups/drug-test/payroll; Cameron may contribute coaching-protocol + fin-lit modules. via Gerald 8/17: Aiming for Super Green (7-8 modules). The project HQ is built, the list of core trainings is defined, and the build order is set. The first module (Samsara Management) is in build now. Pace is the whole game: one module every two weeks gets to the 7-8 set by Oct 31 — tight but workable. Nothing structural is blocking (no tooling or ownership gaps); the only risk is holding that every-other-week cadence.",
    ...
    {
      "name": "Fabian Urrutia",
      "title": "Sr. Developer (under Matisen)",
      "goals": [
        {
          "name": "Refine Automated QA Process — AI Agent for Bug Hunting",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Setup and train Automatic QA Agents that create pull requests triggered by the EMMA v4 Slack Channel and does independent nightly qa",
          "green": "Setup and train Automatic QA Agents that create pull requests triggered by the EMMA v4 Slack Channel",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728352511"
        },
        {
          "name": "Roll Out Mobile App Update — UX Improvements + First Feature",
          "critical": true,
          "status": "unknown",
          "assessment": "8/20: Clover integration = last mile; deployment HELD until back from paternity leave (Marcella due ~9/20, ~2-wk delay accepted); Lift Up coverage meeting Fri 8am; Cameron wants updated launch estimate — Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "App passes qa and is ready for roll out by October 1st with Android Version and MCP alternative identified",
          "green": "App passes qa and is ready for roll out by October 1st",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728346777"
        },
        {
          "name": "EMMA V4 Quality-of-Life Sprints — 2 QOL Rounds",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Both Quality of Life sprints completed",
          "green": "1 of 2 QoL sprints completed",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728346836"
        },
        {
          "name": "Fabian — BigQuery Reconciliation + Data Cleanup (post mobile-app rollout)",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Big Query Sync Fixed, Fulfillment Reporting Compatible with v3 without dashboard bugs, Repeat Customer Cleanup (doesn't include customer dedupe), Google Offline Conversions connected to Emma",
          "green": "Big Query Sync Fixed, Fulfillment Reporting Compatible with v3 without dashboard bugs, Repeat Customer Cleanup (doesn't include customer dedupe)",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "12612475417"
        },
        {
          ...
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Api endpoints implemented for Sage integration",
          "green": "Scope out Api integration for Move Contract imports into sage",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3"
        }
      ]
      ...
      "goals": [
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Linda 8/18: No board or session activity tracked against this goal yet this quarter — this is a placeholder first read, not a real assessment. Correct next cycle if work has actually started (Rippling claim-submission app build with Matisen, OSHA-recordable field spec, on-site incident workflow documentation/BM training).",
        ...
        },
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "via Linda 8/18: 10 decisions locked from the 7/3 design workshop (Cameron + Anne + Paul); damages mechanism now has real clarity via Cameron's 7/30 QGR ruling (in the promotion gate AND the bonus — corrected the Green bar below, which previously described damages as a weighted 100-point input, the superseded 7/28 compromise language). Blocked on the backtest, which is what stands between here and the Green bar's 'backtested against one real branch' requirement.",
          ...
          "green": "Methodology fully designed — every dimension mapped to point values and weights, with damages implemented as a promotion-gate criterion per Cameron's 7/30 ruling (in the gate and the bonus, not a weighted score input) — signed off by Cameron and Paul, backtested against one real branch by Oct 1.",
          "sourceUpdated": "2026-08-18",
          "source": "cos-feed",
          "pulse": "11752777323"
        },
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "via Linda 8/18: No board or session activity tracked against this goal yet this quarter — placeholder first read. Correct next cycle if the practice design, Roundtable adoption, or RM/BM pilot has actually begun.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "8/21: Anne asked to BUILD HER OWN engagement-survey app rather than re-run it through Monday (admin friction + UX); Cameron approved — she develops mockups/wireframes off her survey cadence + database structure toward a v1 prototype tested on a small group. This is her unblock path for this goal. Separate from the anonymous 180 EQ survey, which is Rob's and is Cameron's personal read. via Linda 8/18: No direct progress tracked this quarter — only tangential context: Linda's SCB ask to Albert about where the employee engagement survey lives (tool + historical results). Cameron replied 7/16 that he was 'actively working on it' to get it into the QGR packet; no update since (over a month stale as of 8/18). Unclear whether that thread is the same platform this goal depends on. Needs Anne's real read plus a check with Cameron on whether that's still moving.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "8/21: GO-LIVE DATE SET — trial-day elimination targets END OF AUGUST, agreed in the 8/21 huddle. Contingent on Anne shipping (a) a high-level manager overview of what changes (the difference, not the detail) and (b) a crystal-clear announcement. Brian can hit the date if he has it by next week; Mike flagged rollout was expected earlier in August. The date exists specifically to stop the drift. via Linda 8/18: Framework substantially designed — 10 decisions locked 7/3, hours-floor re-based to Option B 7/17, backtest spec amendment posted. Damages resolved by Cameron's 7/30 ruling (in the gate AND the bonus — corrected the Green bar below, which previously described folding damages into the 100-point score, the superseded 7/28 compromise). Still blocked on the same paused backtest as Goal 2, plus two open HQ decision items not yet ratified.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Linda 8/18: Only tangential motion this quarter — the AJG broker transition (Amy Balistrella left 8/14, Cali Beeman + Katie Clark taking over) and the ACA variable-hour classification risk flagged 7/31, both adjacent to but not the same as open-enrollment execution itself. No 2027 plan-year decisions locked with Cameron/Paul yet that this COS is aware of. First Q3 read — needs Anne's confirmation.",
    ...
    {
      "name": "Jalissa",
      "title": "HR Generalist (under Anne)",
      "goals": [
        {
          "name": "Anne — Hiring Targets 105% (Summer Peak)",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "≥80% compliance in the recruiter lane AND ≥80% in the HM lane, tracked separately so a miss is attributable · zero silent breaches of the 10-day backstop (any crossing has a documented reason: stage dropped, expedited, or req killed) · recurring compliance report (weekly or biweekly) broken out by lane and by branch, so a chronically slow branch is visible",
          "green": "Full SLA document published covering both swim lanes + the pipeline backstop — Recruiter (Jalissa): pre-screen within 1 business day · phone interview scheduled within 2 business days of HM greenlight · in-person scheduled within 2 business days of passing phone screen · rejected candidates notified same day as req closure. Hiring Manager: pre-screen → phone-interview go/no-go within 1 business day · in-person decision within 2 business days (3 max). Backstop: 10 business days application → HM decision, hard ceiling. Escalation: HM silence on a follow-up escalates to Anne after 2 business days. SLAs socialized with all 10 branch managers (delivered, not just written) + 2–3 weeks of real baseline compliance data captured (ClearCompany pull once creds land, or a manual export) so the first read is measured, not guessed",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11733894186"
        },
        {
          "name": "ClearCo ATS Rollout + Hiring Funnel Visibility",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "",
        ...
        {
          "name": "HR Compliance Audit Cadence (was: Onboarding Experience — Close It Out)",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Two consecutive audit cycles run on cadence (per area) with zero unresolved findings carried forward · standing audit log/tracker exists so cycles aren't reconstructed from scratch",
          "green": "Documented audit checklist covering all 6 compliance areas, each on its assigned cadence (weekly / biweekly / ~3 days pre-month-end / monthly) · first full audit cycle completed for every area with findings logged (not just \"looked clean\") · any first-cycle findings have a remediation plan, even if not fully resolved · benefits-termination subcategory: 100% of terminations in the audit window confirmed termed in BOTH BCBS and Mutual of Omaha by end-of-month of last day worked",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728362110"
        },
        {
          "name": "Implement WHO/Culture Interviews — Improved Phone Interview + Position Scorecards",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Position scorecards built for all 7 roles: Customer Experience Representative, Customer Solution Representative, Mover, Field Manager, Flex Manager, Operations Manager, Branch Manager",
          "green": "Cultural phone interview finalized, in use, and programmed into ClearCompany · position scorecards built for Customer Experience, Mover, and Field Manager (3 of 7 roles)",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11752750983"
        }
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Gary 8/17: Yellow — past its own target date, not blocked. This yellow is not a pace call — it is a date this rock set for itself inside Q3 and passed. Target launch was the first week of August; it is 8/17 and the bot is still in testing, so the Green bar ('running consistently with bugs fixed') is not met. Content side is fully closed out: every commitment from the 7/20 Botpress handoff is done, including the 11 lower-volume FAQ confirmations and the 16-answer sheet. Nidha (Botpress) is drafting the BotSpec; escalation routing confirmed to Slack #chatbot-notifications. Messenger token moved to Paul Morin 8/3 (Amanda lacked Meta Business Manager rights) and is no longer hers to chase.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Gary 8/17: Green — ahead of pace. The confirmation email redesign is built and matches the new RFQ visual system. It has not been approved or queued in EMMA yet, which is what the Green bar ultimately requires, but at 60% done with ~18% of the quarter elapsed this is running ahead of an even burn. Currently a private Artifact. Sharing it out to Kickpoint is snagged on an org-level setting: Claude's 'anyone with the link' sharing is disabled company-wide, so external delivery needs the raw-file workaround. Quarter context: as of 8/17 the quarter is ~18% elapsed (Aug 1 – Oct 31), so this percentage should be read against an early-quarter baseline, not against a completed-quarter figure.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Gary 8/17: Green — early and on track, with the main input still to land. Amanda is working with Matisen to get daily call grading delivered; that feed is what makes the coaching side of this rock workable, since the plan is to coach the lower estimators off regular, transparent numbers. At ~10% with ~18% of the quarter elapsed this is marginally behind an even burn, but the room's own caveat applies: estimating is a delayed result, so work done now will not show up in accuracy numbers for two weeks to a month or more and is expected to lag. Bars confirmed 8/17 as written on the chart (46% Green / 48% Super Green) — these are the ratified Q3 targets and are NOT on the same basis as the 54% / 56% bars used in Q2.",
    ...
    {
      "name": "Nhel",
      "title": "Sales Team Lead (under Amanda)",
      "goals": [
        {
          "name": "Nhel — Plan CET Philippines Conference (March 2027)",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Budget approved, location selected and reserved, starting to book flights",
          "green": "Budget approved and location selected and reserved",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728336249"
        },
        {
          "name": "Nhel — Manager Sales Accountability (Weekly RM Reporting)",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Weekly reports send to RMs about sales standings, estimating, and call grading, and showcasing individuals who need coaching. Confirmation coaching has been happening and documented.",
          "green": "Weekly reports send to RMs about sales standings, estimating, and call grading, and showcasing individuals who need coaching.",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11733924241"
        },
        {
          "name": "Launch Sales Competitions — Small Bonus Incentives to Drive Engagement",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "",
    ...
    {
      "name": "Tetet",
      "title": "Sales Enablement Mgr (under Nhel)",
      "goals": [
        {
          "name": "Tet — Sales Class Level 2 (Advanced Objection Handling + VP Positioning)",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Rance, Shane, Joanna, Nicole, Steven, Klepac, one additional sales team member: Level 2 training",
          "green": "Rance, Shane, Joanna, Nicole: Level 2 training",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11733922022"
        },
        {
          "name": "Tet — Sales Training Improvements (update sales training)",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Plan approved and started",
          "green": "Review the entire training program and create bullet points and a plan of what needs to be changed, updated, and who is in charge of what. Submit for approval",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728354506"
        },
        {
          "name": "Coordinate Jules doing training / ride-alongs with low-performer sales team members",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Jules rides along with new hires (3) and low performers (5). Create a plan to establish a ride-along process ready to roll out this quarter",
          "green": "Jules rides along with new hires (3) and low performers (3)- Create a plan to establish a ride-along process",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "12601585701"
        },
        {
          "name": "New-Rep Ramp — Sales Speed-to-Competence",
          "critical": false,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Bri, Chauny and Jevic 105% sales goals",
          "green": "Bri, Chauny and Jevic 100% sales goals",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3"
        },
        {
          "name": "Personal sales goal",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "100%",
    ...
    {
      "name": "Carly",
      "title": "Claims Manager (under Amanda)",
      "goals": [
        {
          "name": "Auto-Email for Damage Claims — Meet Our Claim Rep + Policy Info",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Email live",
          "green": "Email created and approved. In the queue for going live",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728355487"
        },
        {
          "name": "Carly — CX Q2 Theme Execution (Carly's Contribution)",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Lead quarterly theme for the whole department, set timing, and ensure weekly excitement and updates by Monday of each week",
          "green": "Lead quarterly theme for the whole department, set timing, and ensure weekly excitement and updates by Tuesday each week",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11733922589"
        },
        {
          "name": "Launch Customer Outreach Program — Stop/Start/Keep + Case Studies",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Create a process and questions for customer outreach and speak to 30 customers",
          "green": "Create a process and questions for customer outreach and speak to 20 customers",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3",
          "pulse": "11728354516"
        },
        {
          "name": "Carly — Ramp-Back + Magic Moments Phase 2",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "Phase 2 of Magic Moments updated with plan and rolled out",
          "green": "Phase 2 of Magic Moments updated with plan or rollout",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3"
        },
        {
          "name": "Customer Resolution Certification",
          "critical": true,
          "status": "unknown",
          "assessment": "Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
          "superGreen": "All managers, the sales team, and claims are certified",
          "green": "Training complete; certification has started",
          "sourceUpdated": "2026-07-30",
          "source": "qgr-fold-q3"
        }
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "8/20: 54 missing-ID errors reconciled to 4; nightly runner live (no more manual spreadsheet pulls); QGR command center folds into hub today, call grading Fri — via Matisen 8/19: A and C converge on one build: the weekly scorecard is being baked into hub.einsteinmoving.com rather than shipped as a separate surface. The hub stands up, stats are shipping over, and the Games automation shipped 8/18 (mover view, parity proofs, per-branch worklists) — 8/19 verifies the overnight pull-through and wraps the Data Hub integration; scorecard migration and the AI Use Policy draft follow. C is the shared build with Cameron's Data Bus rock (pulse 12556198241): Matisen ships bus/registry infrastructure, Cameron's goal owns governance. Open item on A is rollout and access with Cameron, not scoping. B gated on Wednesday's LiftUp meeting. D moves this week — registering EMMA with Sage Intacct.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Matisen 8/17: A: targeting within MPE of the forecasting models by quarter end. B: quote accuracy shared with Nhel; call-grading automation and conversion on the sales target dashboard still to build. C: email rollout pending confirmation with Fabian — lead triage is queued ahead of it. D: chatbot in QA testing for Phase 1. Dependency: Amanda.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "via Matisen 8/17: 0 of 48 submitted for Q3. ~25 CHOICES-anchored candidates staged since 8/10; plan is to submit 12 this week. Measured on the Praise Board or a new PL in Rippling — but the Praise Board's clear-on-status automation is dead and its count conflates intent with delivery, so the rock cannot be scored until a measurement source is owned.",
      ...
      "goals": [
        {
          ...
          "assessment": "8/19 1:1: SG — 5 photos + 3 videos in 2 wks, SLA clean; DoD band photos · Tampa photo · landmark photos by EOM. Ratified in the 8/3 sync, day 1 — no execution data yet. Q2 context: short form ruled RED (2 of 4 posted, likes unverified).",
        ...
        },
        {
          ...
          "assessment": "8/19 1:1: Green by his read — comms out strong (Delegation board + watercooler), content back thin; FM guide done 8/14; Klepac (SA) unresponsive → Brian in a week. Ratified 8/3 with a ramp-in: N. Austin-heavy first ~6 weeks is fine; half from other branches by Sept & Oct. FM guide due Aug 31; weekly branch-board pulses by mid-Sept. Q2 context: ruled RED.",
    ...
    },
    {
      ...
      "goals": [
        {
          "name": "Q3 goals — set outside the QGR fold",
          "critical": false,
          "status": "unknown",
          "assessment": "⚠ External partner — not in the 7/30 Q3 fold (that fold covers Einstein goal-owners only). Ben Young's Q3 scope is set through the engagement, not the cascading sheet. Q2 entries archived in dashboard-data-q2-2026.json.",
          "superGreen": "",
          "green": "",
      ...
      "goals": [
        {
          ...
          "critical": false,
          "status": "unknown",
          "assessment": "⚠ External partner — not in the 7/30 Q3 fold (that fold covers Einstein goal-owners only). Kickpoint's Q3 scope is set through the engagement, not the cascading sheet. Q2 entries archived in dashboard-data-q2-2026.json.",
          "superGreen": "",
          "green": "",
          "sourceUpdated": "2026-07-31",
          "source": "external"
