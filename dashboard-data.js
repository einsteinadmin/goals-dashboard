const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-04-01T11:15:00-05:00",
    "refreshedBy": "Albert (digest — 4/1 huddle)"
  },
      ...
      "numbers": [
        {
          ...
          "actual": "Quote form live 3/30, Phase 1 pricing post-conference",
          "status": "green",
          "note": "Variable pricing quote form launched 3/30. Recapture queue resolved — abandoned leads hidden behind super admin (Phase 2 future work). EMMA pricing tool confirmed working: per-branch, per-day pricing with rules stacking. Phase 1 (day-of-week ±$5) goes live post-conference. Phase 2 (May 1 base rate increases) under Roundtable review — Option A vs B not yet decided. Rate card + full analysis shared with managers for comment. #variable-pricing Slack channel being created. Pricing tool being locked to super admin."
        },
        {
