const DASHBOARD_DATA = {
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "6/18: 7-critic hostile expert audit run (~1.08M tokens) → verdict 'SHIP v1, fix one blocker first' (mid-floor 'See my price' CTAs scroll to a 1px aria-hidden div, not /quote/ — one-line href fix). SEO concern overblown; Floor-2 de-densify the one non-debatable fix. v2 Peekaboo built (forces peekaboo at all viewports, removes mid-floor CTAs, de-densifies Floor 2); both v1 + v2 sent to KP w/ Cameron's position (v1 still the preference; v2 only if Jeff scopes v1 as too expensive). Awaiting Jeff's build estimate — v1-vs-v2 scope delta is the deciding input. 🔴 STILL GATING = Cameron reviews KP's 5-page .md feedback + locks homepage components -> unblocks Emma's next sprint. | Prior 6/17: direction locked to continuous Mover Journey desktop (Cameron's v1 pick), reduced flexibility accepted; quote funnel reconciled (Option 2; Jeff builds staging front-end).",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "unknown",
          "assessment": "6/17: two parts scoped — BigQuery data integration (internal/Matisen; warning: no named owner yet) + Prosper data integration (Laura, on her return from vacation). No live dashboard yet. Prior: Rob's 2027 roadmap puts ROAS as priority; recommend move to Amanda.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/17 launch conversation: homepage animation direction locked (continuous Mover Journey desktop, reduced flexibility accepted); open dev Q to Rich re: elevator-seam flexibility. Next gate = Cameron reviews KP's 5-page feedback + locks components -> unblocks Emma's next sprint. KP out ~2 wks (Laura vacation, Elizabeth/Sarah out next wk); next check-in first week of July.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/17: existing 'What to Expect' YouTube video to embed in the quote follow-up email now (swap polished version later); MGML->HTML conversion in-house; tokens pending (mockup placeholders for now). Internal team owns implementation; KP owns design + copy.",
          "superGreen": "Rolled out company-wide with measurable impact",
          "green": "Houston test complete, company-wide decision made"
        },
        {
