const DASHBOARD_DATA = {
 "meta": {
  ...
  "statusHistoryStamped": "2026-09-23"
 },
 "network": {
  "phase": "1",
   ...
   "goals": [
    {
     ...
     "critical": false,
     "status": "green",
     "assessment": "via Linda 9/22: Preauthorization workflow proven 4x live. 9/22 session with Mike and Brian worked the two-day minor-injury rule hard and landed on an automated-leave design that resolved Mike's core objection. Anne's driving case, stated in the room: people have been out a month with nothing submitted to Texas Mutual, no FMLA issued, and no notification to EE. Green bar's second half — workflow trained to all 10 BMs by EOQ — still not started; the presentation review is dated 9/23.",
    ...
    },
    {
     ...
     "critical": true,
     "status": "green",
     "assessment": "via Linda 9/22: 100-Point HQ sent to Mike and Brian 9/22, ahead of the 9/24 commitment. Mike confirmed on the 9/22 call he is an advocate in principle — \"totally on board... once I get the nitty gritty\" — and named the reason to lead with: managers can't tell an A player from a C player, and a point system does that for them. Green bar is Cameron + Paul sign-off by Oct 1, so Mike/Brian review advances the work but is not the bar. Still owed by Anne: the tiering/termination-count analysis Cameron asked for, and the unemployment-eligibility answer via Jennifer.",
    ...
    },
    {
     ...
     "critical": true,
     "status": "yellow",
     "assessment": "via Linda 9/22: Walkthrough held 9/22 with Mike and Brian (Amanda absent). The app itself was praised twice; the underlying design was rejected and redesigned in the room. Adoption remains zero, which is what the bar measures. Anne sent Cameron a written summary of the table's feedback the same day and asked for everyone in one room rather than relaying objections. Confidence drops to 3 because the rock's Green bar now measures a mechanism the stakeholders have moved off.",
