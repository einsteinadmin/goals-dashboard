      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "9/1 sync: Hub access ships to the LEADERSHIP team this week (manager rollout waits on permissions \u2014 comp docs currently visible); TUR tile flagged as likely first QA question. Sage needs the licensed API key (free tier lacks it; ~$2.5K Rippling REST API decision incoming). EMMA MCP tested this week \u2014 pulls correctly but the new DB syncs wrong info; corrections handed over. Region scorecards ride the hub rollout, then managers.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "9/1 sync: Call grading confirmed running NIGHTLY (old rubric \u2014 7:45a/9:37p runs); Amanda's by-hand restart reconciled \u2014 rubric evolving, join lands post-move-close; WHERE grades live goes to Thursday's parking lot + Amanda's top-KPI list gets piped in. Committed: Jeff's two conversion buckets (repeat/referral vs net-new, company + per-rep) before ~9/11 + sales-capacity coverage tool to Northwood after validation. Botpress newest version to Amanda w/ test cases baked in.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "9/1 sync: \u2b50 mover-promo retroactive/backtest to Anne + Paul committed WED/THU this week \u2014 unblocks her framework. Performance log to Anne + Rippling piping; newest mobile-app build QA today then manager hands-on scheduling. Rippling pivot: custom FIELDS on existing objects (not a custom object) + new schedule API endpoints.",
          "superGreen": "100% Green or higher (4 of 4)",
          "green": "75% Green or higher (3 of 4)",
          "sourceUpdated": "2026-09-01",
          "source": "meeting-digest",
