const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-05-18T15:30:00-05:00",
    "refreshedBy": "Albert (digest \u2014 Roundtable group sync 5/18)",
    "archive": {
      "quarter": "Q1 2026",
      ...
      "numbers": [
        {
          ...
          "actual": "Cameron Rock #5 (Cameron owns since Amanda's plate is full). KP design system proposal pending review.",
          "status": "green",
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "Cameron owns since Amanda's plate is full. CMS decision LOCKED 5/11 \u2014 staying on WordPress, building new FSE block theme. Albert via WP REST API as editor-AI layer. KP proposal/SOW pending. Brand-story HTML review with Albert this week.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "Mover comp LOCKED 5/14 (Ben validated 5/13). $20 flat Lead in Training + Lead $1.50 base/$0.50 var. Co-Pilot retired. HOF retired as paid position. ~$600K annual increase, under 40% mover/rev ceiling. Anne reposted all postings same-day 5/15. Rippling rates updated 5/16. Announcement ships Mon AM 5/18. Manager comp May 20 cycle on Paul's v3 model with above-band raises layered.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "5/18: Hiring sprint active \u2014 target 20 new offers by EOD Fri 5/22 (20% bump on last week's 16). Jesper flexed full-time to phone interviews. FM accountability for first-day onboarding locked. Trial days \u2192 1 day immediately, sunset 6/1. 100+ screened applicants 6+ days old in CTXH = risk (Anne flagged). SCTX 5 branches still under target.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "5/18: 9 FM candidates in DFW pipeline, last screener Wed 5/20. Terrel flexed full-time to phone interviews. DFW hiring aggressive \u2014 pushing 10+ hires this week. Mike + Anne touch base Wed on FM go-forwards. Tampa OM Stephen Anderson continuing ramp.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "5/18: 4 candidates being scheduled this week. Cameron + others sitting in on interviews based on availability.",
