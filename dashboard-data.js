      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/15: call grading + report ready; first run done (~41/80+). DoD: spot-check 15 calls to calibrate. Publish to GitHub (obscure URL + no-crawl).",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/15: Botpress SELECTED (cost delta acceptable). DoD: contract → Paul → implement. Super Green if live by EOM.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: KP delivered final copy. Implement in EMMA w/ Matisen+Fabian; MJML vs HTML decision pending (Matisen researching); RFQ template first, then the rest.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: First Class Precision going great, competitive. DoD: leaderboard out by Tuesday AM.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "red",
          "assessment": "6/15: Red — same as Mike; launches first, targeting EOM.",
          "superGreen": "Read by EOQ + 1-page reflection on personal H/H/S gaps",
          "green": "Read by 5/30"
        }
      ]
