const DASHBOARD_DATA = {
 "meta": {
  ...
  "statusHistoryStamped": "2026-09-17"
 },
 "network": {
  "phase": "1",
  "phaseLabel": "All 7 COS live — Q3 tracking opens",
  "lastRefreshed": "2026-09-17",
   ...
   "goals": [
    {
     ...
     "critical": true,
     "status": "green",
     "assessment": "9/16 huddle: hub runs moving off his laptop to a remote server (expected 9/17); Games driver-safety tile = quarter average of weekly scores vs Samsara QTD (known discrepancy, retooling to show both); 240 offline Rippling time-clock punches unmonitored, taking to Carly. via Matisen 9/14: B moved: the EMMA bridge packet, the CoS call inventory and the endpoint RFC were published 9/10 and LiftUp walks them line by line Tue 9/15 8am; the ruling is no rewrite and no new datastore, repoint reads to the existing secondaries instead. A is unchanged: region scorecards are built but still not delivered. D (Sage) is paused as of 9/11 until the Rippling kiosk punch conflicts are resolved.",
