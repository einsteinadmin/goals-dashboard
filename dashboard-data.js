const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-07-13T14:00:00-05:00",
    ...
    "lastRefreshNote": "7/10 /retro deep refresh (short week — Cameron back Wed 7/9 from Seattle, working days 7/9–7/10). No status FLIPS needed vs the 7/9 digest pass — statuses verified current. Movement this week: Brian Hiring (Red→moving): NA BM decision LANDED — Daniel selected on the new 50/50 Position-KPIs+Choices scorecard (People Analyzer retired; Vera built the tool; rejected candidates get scorecard feedback+dev plans; comms Mon; peer-review scope + manager-bench pipeline → next-quarter recruiting rock). QGR pre-work ramping across all leaders (Rob half-day 7/15). Matisen: EMMA read-only MCP in QA (sales/rev/conversion pulling; Games data still validating; Rippling hours done); mobile/field app beta rollout targeted 7/10 eve; Rippling-timecard fix + LeadFerno pull fixed. Anne: mover-promotion metrics + employee-engagement survey (7/6–13) live; PTO cost model on 7/9 Prosper call. Mike: mover-app Dallas/Garland beta strong, common-mistakes driver module started. Rob 1:1 coaching (7/10): Paul=CFO framing, speed-to-competence named as #1 constraint, travel-week pilot, theme-fatigue watch. Facilitation avg ~4.0 for the 2 working days (huddles 4.0×2, BM working sessions 4.4/3.8).",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Clark 6/16: Well on its way, about 85% done and solidly on target for Green. To reach Super Green we still need to build the promotions-tied-to-performance framework and the promotion-process video, then communicate it to the team. Confident (4/5) we get to Super Green.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "supergreen",
          "assessment": "via Clark 6/16: Hit Super Green. Moved in on June 15 and we're good to go.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 7/2: Leander visit + ride-along with Brian done. DFW trip planned for July 13 or 15 after the World Cup game with Cameron — could cover 2-3 branches in one trip. Green is likely; Super Green (3 visits + 3 ride-alongs) depends on DFW branch count.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 6/16: On pace for Green. Will finish the book plus the one-page reflection by end of quarter.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 6/16: Haven't started anything yet, but confident we'll land Green or Super Green by end of quarter.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "7/13 (Brian 1:1): Brian moved Red → Green — all teams over revenue-FTE targets (NA 106% · SA 110% · Leander 95% · San Antonio 108% · Houston 108%); NA BM landed (Daniel on the new 50/50 scorecard, People Analyzer retired). ⚠ Caveat: the quarterly personnel-budget AVERAGE may still land red from the two May misses that can't be un-missed — QGR self-grade settles green-vs-red. DoD: Vera builds a hiring/personnel dashboard (R/G/SG by branch). Peer-review scope + manager-bench depth → Q3 recruiting-pipeline rock.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Albert 7/2: PROPOSED yellow→green (dashboard 6/23): Vera scrum-scorecard skill running across all branches (Sergio, Houston, N. Austin, S. Austin) + best-practices reference now on GitHub Pages (6/30 commit). O3 completion still the open leg. (harvested draft — unconfirmed)",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Albert 7/2: Green, tracking Super Green — 3 of 5 done per dashboard 6/23; needs S. Austin + Houston. ASK: did the S. Austin visit happen last week as planned? (harvested draft — unconfirmed)",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Albert 7/2: Yellow — 7/2 huddle: fixing the Training Day app + DB going out so next week's TD is organized; Legend-of-the-Week rotation codified (branch legends on TD weeks, leadership legends weekly). TD feedback app live in NA/LEA/SAR. (harvested draft — unconfirmed)",
        ...
        },
        {
          ...
          "assessment": "via Albert 7/2: PROPOSED green→supergreen (dashboard 6/23): Section 4, page 91, steady pace alongside Cameron + Mike. (harvested draft — unconfirmed)",
          "sourceUpdated": "2026-07-02",
          "source": "cos-feed"
        }
      ]
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": false,
          "status": "supergreen",
          "assessment": "7/2 huddle: App is IN THE WILD — Dallas teams live on it, Mike self-testing as a mover through sprint 4 with no issues. Mover + manager SOPs auto-drafted by Gerald from source code (~10-15% edits left, finishing today). If beta validates, full rollout is the leading Q3 'Back to School' theme candidate.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "7/9: Green. EMMA read-only MCP in QA (Robert build) — sales/revenue/conversion pulling correctly; Einstein Games data not yet pulling (validating); Rippling hours done. Mobile/field app rollout targeted eve of 7/10. Packaging dashboard reports back to Robert to bake into MCP responses.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "red",
          "assessment": "6/30: moved Green→RED. Call grading is PENDING Amanda (confirm she's grading 80-100% of calls); next step = incorporate an \"actual estimate\" into the grading (Amanda works w/ Matisen). Games automation partly working; Claims RAG database is low priority → the red. Path back to green: if Games automation lands, it REPLACES the Claims RAG and the rock goes green.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/30: Green. (Anne's hiring-funnel dashboard still gates on this + the long-open Rippling decision — unblock + date still the watch-item; ran on a stale tab so the push didn't surface live.)",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/30: Green. Robert's back reviewing bottlenecks; some Rippling obstacles; a few items to officially roll out (several = live Claude dashboards/skills over EMMA).",
        ...
        },
        {
          ...
          "superGreen": "Read by EOQ + 1-page reflection on personal H/H/S gaps",
          "green": "Read by 5/30",
          "assessment": "6/30: moved Super Green→GREEN. Still working through the book + one-pager (out most of last week on vacation)."
        }
      ]
    },
    {
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "supergreen",
          "assessment": "via Linda 7/1: 6/23: Jalissa onboarded + taking recruiting (Anne refrains unless tagged). This week: teach her Rippling + Monday (DoD = she understands our Monday processes). Daily morning meetings in place; may delegate board automations to Linda. SG locked.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Linda 7/1: 6/29 sync: Go-live SET for July 6 — messaging out July 1 (framed as phase-1 of a multi-phase rollout). Anne drafts mgr + mover messaging, Matisen updates onboarding checklist, Brian reviews + aligns in sync-ups. Interview process shortened to 2 steps, Concentra HPE network built (activation in ClearCompany pending), Extended Trial Period (60-day, check-ins 1wk/2wk/30d/60d) designed.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "supergreen",
          "assessment": "via Linda 7/1: 6/23: Gated on Matisen (back Thu 6/25). ClearCo has reached out multiple times for him to connect — Anne schedules the sync once he's back; needs a fallback if timing slips. NOTE: source status field says supergreen but assessment reads stalled/gated — flagged mismatch, unresolved as of bootstrap.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "7/2 huddle: Rippling onboarding module (culture/core values w/ embedded quiz, interactive) LIVE for all new movers from 7/1 — feedback requested from a Houston mover + managers getting the module too. Handbook DONE (~50 readable pages) — Anne PDFs + swaps it for the old one today. Tracking toward Super Green.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Gary 7/3: Green — grading engine LIVE. Calibration 15-call spot-check still pending. Next: huddle w/ Nhel on call-grading distribution plan. Dashboard flags May company-wide $ conversions at 80.78% of target (Red floor) as the real lever to watch. Cameron's weights-workshop tool built and ready; Amanda deferred reweight 6/24. New integration ask posted to SCB 7/3: link Dialpad grades to Emma estimates + actuals.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Gary 7/3: Green, trending Super Green — Botpress contract SIGNED (6/29). Implementation kickoff ran today (7/3) with Matisen. Matisen + technical team meet 7/7 (1PM ET) on API integrations. Target launch: first week of August 2026. Project HQ built at projects/botpress-implementation/botpress-hq.html.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Gary 7/3: Green — Matisen made the token/format decision. Gate cleared. Next: RFQ template live in EMMA, then company-wide rollout.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Gary 7/3: Green — First Class Precision running strong. Nhel owns weekly announcements + cadence. ~4 weeks of competition left.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Gary 7/3: Yellow — reading DONE (confirmed 7/2). One-page H/H/S reflection still needed (due 7/25). Huddle 7/3: Cameron clarified the ask — personal reflection (3 lowest H/H/S scores) + run Gary as Lencioni to build a 3-month action plan. Organizational layer (interview process / People Analyzer changes) is Anne's ask, not Amanda's.",
          "superGreen": "Read by EOQ + 1-page reflection on personal H/H/S gaps",
          "green": "Read by 5/30",
          "sourceUpdated": "2026-07-03",
          "source": "cos-feed"
