const DASHBOARD_DATA = {
 "meta": {
  ...
  "lastRefreshed": "2026-07-10T15:15:00-05:00",
   ...
   "goals": [
    {
     ...
     "critical": true,
     "status": "green",
     "assessment": "6/23: Moved Yellow → Green (Brian's self-read, confirmed). Recent results: S. Austin beat Dallas, San Antonio upset undefeated Fort Worth (San's first win). Leander leading their conference. N. Austin at 6.4 (laggard). Most CTXH branches near/above 7; S. Austin strong. DoD: run Vera Einstein Games skill to get full regional analysis + share output with Cameron. Matisen asked to add company-wide / region-wide baseline to the performance report. Company-wide score 8.8 (strong).",
