const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-04-08T09:00:00-05:00",
      ...
      "numbers": [
        {
          ...
          "status": "green",
          "note": "VP meeting 4/7: Option A confirmed. $5 blanket May base rate increase pushed by Matisen. Terminology locked: Standard/Value/Best Value. Day-of-week rollout gated on Amanda training videos (this week). Manager + mover announcements drafted. EMMA auto-adjusts on date change. EMMA wild quotes issue flagged (Khevan: 6.75 hrs small move, 4 guys 2 trucks for 1-bedroom) — surface to Matisen. Phase 2: location-specific tuning + weekly review cadence."
        },
        {
      ...
      "numbers": [
        {
          ...
          "status": "green",
          "note": "VP meeting 4/7: Option A confirmed. $5 May blanket increase pushed by Matisen. EMMA pricing tool confirmed working + auto-adjusts on date change. EMMA wild quotes issue flagged (Khevan) — needs investigation. Games fix deployed. QoL email templates in QA, mobile-friendly pages rolling. VP After Action Review end of week."
        },
        {
          "name": "EMMA Bug Count",
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": true,
      "status": "green",
      "assessment": "Variable Pricing Phase 1 LIVE (3/30). 4/7 VP meeting: Option A confirmed. $5 blanket May base rate increase pushed by Matisen. Terminology locked: Standard/Value/Best Value. Day-of-week rollout gated on Amanda training videos (this week — she's out Friday). Manager + mover announcements drafted. Location landing pages: staging from KP. EMMA wild quotes issue flagged (Khevan: 6.75 hrs for small move, 4 guys 2 trucks for 1-bedroom) — needs investigation with Matisen.",
  ...
  "leadership": [
    ...
    },
    {
      ...
      "title": "Dir. of IT",
      "goals": [
        { "name": "Variable Pricing", "critical": true, "status": "green", "assessment": "Phase 1 live. 4/7 VP meeting: Option A confirmed. $5 blanket May base rate increase pushed. Terminology: Standard (Fri/Sat), Value (Sun/Mon), Best Value (Tue-Thu). Day-of-week rollout gated on Amanda training (this week). EMMA wild quotes issue flagged (Khevan) — needs investigation. ProKeys broken — not a blocker. EMMA auto-adjusts on date change.", "superGreen": "Launch within timeline budget, one sprint push allowed", "green": "Launch within timeline budget, two sprint pushes allowed" },
    ...
    },
    {
      ...
      "goals": [
        ...
        { "name": "Evaluate CFO Needs/Budget", "critical": false, "status": "green", "assessment": "Prosper VCFO confirmed. Joselle + Mike S finance transition Friday 4/11. Green — decision made, execution underway." }
      ]
    },
    {
