      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "7/13 (Amanda 1:1) via Gary: Green — grading trusted + Nhel/Tetet tweaks folded in, but weekly cadence STALLED (no bandwidth during sales-class training). ⚠ Accuracy report is BROKEN (last run June ~50) — needs Matisen to re-run. Real roadblock = no time to review graded calls; plan = async self-review tool w/ Gary (rep-specific links + Claude/Slack alerts). Hosting resolved 7/13 (obscure-URL default, pending Amanda's transparency call). % of real calls graded = the SG gate.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "7/13 (Amanda 1:1) via Gary: Green — 7/7 API meeting set strategy; Leadferno history isn't exportable so Matisen is extracting training data via Claude (started 7/13, no ETA). Launch first week of August. ⚠ SG needs live-by-7/31 — an August launch lands this Green, not SG. Watch Auto-Recharge ceiling.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "7/13 (Amanda 1:1) via Gary: Green but BLOCKED on Matisen — designs done; RFQ template slipped past 7/10, no firm date, EOQ target. Amanda pushing at the Wed huddle parking lot for a timeframe + rollout call (company-wide vs Houston test).",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "7/13 (Amanda 1:1) via Gary: Yellow → green — reading DONE (7/2). Gary interviewing her to finish the one-page H/H/S reflection (HTML/PDF), targeting 7/15 (7/25 outer bound). Then Gary-as-Lencioni for the 3-month plan.",
          "superGreen": "Read by EOQ + 1-page reflection on personal H/H/S gaps",
          "green": "Read by 5/30",
          "sourceUpdated": "2026-07-03",
          "source": "cos-feed"
