const DASHBOARD_DATA = {
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "6/11 KP process meeting: execution pipeline locked + endorsed — Emma refines design system (files 6/11), Cameron mocks pages (inspiration tool live w/ 22 refs + LLM lens; v2 directions next; 3 finalist full-fidelity homepages), then joint component extraction -> Emma builds Figma component library (Einstein owns). Editorial Hospitality dropped; blend origin+proof+local; LLM questions answered in first two homepage sections. Budget confirmed for custom interactive components (mover-journey candidate). Elizabeth feedback wk 6/15. Quote form = locked design foundation. | 6/15: mover-journey concept shown to leadership — explore Blender/AI for SVG/3D + mascots/easter eggs; weigh conversion vs distraction + mobile UX + SEO; more mockups coming.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "Design-system refinement in progress (Emma, files 6/11) while Cameron runs mockup pipeline; component extraction + Figma library next; process locked at 6/11 meeting. On track.",
