const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-03-23T12:30:00-05:00",
    "refreshedBy": "Albert (digest — roundtable 3/23)"
  },
  ...
  "leadership": [
    ...
    },
    {
      ...
      "goals": [
        ...
        { "name": "Regional Growth (Tampa/Garland OMs)", "critical": false, "status": "green", "assessment": "Ops Manager interviews this week: Mon 2:30 Stephen, Tue 3:30 Shane, Wed 11:30 + 1:30. Sales competency questions added. Tampa first priority. Garland reassess post-summer. Garland at 82% to target. Flex Manager Austin deferred to next quarter. South Austin complaints (likely Leander) — Brian following up.", "superGreen": "OM hired and trained for Tampa AND Garland", "green": "OM hired and trained for Tampa" },
    ...
    },
    {
      ...
      "goals": [
        ...
        { "name": "Mongo Schema Roadmap", "critical": false, "status": "green", "assessment": "Service separation planned (3/23): move reporting APIs out of Emma to separate service. DevOps meeting with Gabriel Wednesday to plan isolation for AI agents. Pub/sub architecture + Mongo→Postgres connectors discussed. RBAC changes + new endpoints needed.", "superGreen": "Next-gen architecture defined with systems, system IDs, service calls + roadmap for next steps", "green": "Next-gen architecture defined with system IDs, still scoping service calls" }
      ]
    },
    {
      "name": "Anne Bosse",
    ...
    },
    {
      ...
      "goals": [
        { "name": "Sales Coaching - Conversions", "critical": true, "status": "green", "assessment": "New estimate accuracy goals (3/23): green 54%, super green 56%. Team +6%. Daniel 240%/65% conversion. Garrison 16% (vacation/backlog). Training cohort set (Nhel + Amanda) for Cameron Kleppinger and Rance. Ted focusing on training, audits begin April. Nhel on leave Friday 3/28.", "superGreen": "Above 62.5% within 20% variance companywide", "green": "60% within 20% variance companywide" },
