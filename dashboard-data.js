const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-09-18T16:45:00-05:00",
    "refreshedBy": "Albert (/retro — deep refresh, week of 9/14–9/18)",
    "archive": {
      "quarter": "Q2 2026",
    ...
    "statusHistoryStamped": "2026-09-18"
  },
  "network": {
    "phase": "1",
    "phaseLabel": "All 7 COS live — Q3 tracking opens",
    "lastRefreshed": "2026-09-18",
  ...
  "cameronKPIs": [
    {
      ...
      "target": "66%",
      "actual": "9/17 hub: running-truck 37.2% (Sep MTD, pulled 9/17) · trailing-active 80.6% (Q3) · trailing-fleet 65.5% (Q3). Ruler mismatch vs the 66% target still OPEN with Matisen — do not grade running-truck against 66%.",
      "status": "unknown",
    ...
    },
    {
      ...
      "target": "20%",
      "actual": "9/17 hub: 22.3% company (Sep MTD, pulled 9/17 6:35a) vs 20% target — above bar (week 21.9%).",
      "status": "green",
    ...
    },
    {
      "name": "Customer NPS",
      "target": "90+",
      "actual": "9/17 hub: Sep MTD 86.2 · Q3 QTD 86.6 (GatherUp direct, pulled 9/17 6:35a) vs 90+ target — below bar, 0.2 above the Red line (<86). Chronic Red QTD: Fort Worth 77.5 · McKinney 79.6 · San Antonio 80.3. New in Sept: Houston 88.1 QTD → 80.8 MTD, Garland 89.3 → 83.3.",
      "status": "red",
  ...
  "cameronRocks": [
    {
      ...
      "critical": false,
      "status": "yellow",
      "assessment": "9/18 (retro): photo-verification brief researched, published and posted to Mike (SkyBox 13083953237) — Jev is text-only and cannot approve photos; the real finding is that NO submission deadline exists today (proposal: end of next business day, NOT ruled). Two corrections shipped: the 'heavy data load at 300+ users' read is wrong (8 bytes/photo) and metadata cannot be the guardrail. Duplicate build scoped to Q4/Matisen to protect Mike's plate. Training Camp warnings began 9/18. Rock is honestly yellow: the mechanism is now well understood, the adoption number still is not at the EOQ floor.  |  PRIOR: 9/17 BM roundtable (1:30, 7 BMs + Brian + Mike): six branches now 50%+ across the line at 120 signatures (Leander, San Antonio, Dallas, McKinney, Garland, Tampa) — up from 5 this morning. Room voted to allow DELAYED photo uploads; Mike built and shipped it the same call, as an explicit beta with revert rights. Coupled with a new standard: attestation at handbook sign-in, caught cheating = written warning, second time = termination. 3-signature/day limit RETURNS after Training Camp (settles the KB 'permanent' conflict). Lead PIN sign-off + a leads-who-actually-train dashboard = agreed feature, deliberately deferred to next quarter so it doesn't slow the sprint. Real gap the room went quiet on: no BM has issued a written warning for repeat deniers and we never told them what earns one. ~30-40 people company-wide still have not opened the app. PRIOR — 9/17 huddle: 5 of 10 branches above the line, mix of big and small. Mike's read: managers aren't driving and it is mostly LEADS not engaging (DFW leads think they're already leads and shouldn't redo it; Brian's CTXH read is they forget mid-job). Warnings to managers start Mon 9/21 for anyone not across by Fri 9/18 EOD. Emergency BM meeting called for 1:30 today, all 8 available managers, one room, prep = \"if you're not at 50%, why; if you are, what's your success.\" BM meeting gets a standing every-two-weeks Wednesday cadence, cancel only under ~50% attendance. Mike named the structural issue: this is the one QG you cannot phone in at the end, and managers are hesitant to warn for anything that isn't a direct policy violation. ",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Clark 9/7: 9/7: Matisen still hasn't been able to run the historical analysis. Green remains solid, but Super Green (9/15 milestone) is unlikely at this point. Scheduling a reset with Matisen this week.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/16 huddle: 9 of 10 BM margin sit-downs done on the new CFO dashboard (10th today); 11-pt spread between best and worst margin branches; leadership view in build with Ben. via Clark 9/7: 9/7: Ben completed the Q3 label fix on the branch CFO dashboards. Paul checking back in with the managers and scheduling the accountability meetings this week — target is at least 5 completed by Friday 9/11.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 9/7: 9/7: General SOP completed — now collecting feedback from the team on it. Matisen built a tracker that will be integrated into the process. 60% done, on target for Green.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Clark 9/7: 9/7: Holding at 30%. Commercial moving company hasn't responded to follow-up emails. Titan Up conference (9/2-9/4) completed — gathered strong contacts who have done moving acquisitions, to follow up with for more detail.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "via Clark 9/7: 9/7: Tampa visit completed 9/1-9/2 — 1 of 2 visits toward Green, 50%. Next branch visit needs scheduling.",
          "superGreen": "3 visits",
          "green": "2 visits",
          "sourceUpdated": "2026-09-07",
          "source": "cos-feed",
      ...
      "goals": [
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/17: status set from Vera's 9/15 file on Cameron's ruling (the dashboard had held the 9/1 sync read). via Vera 8/31: was green/3/40 -> yellow/3/55 at 40.7% of the quarter elapsed (37 of 91 days). The roundtable half advanced for real: the first BM strategy session RAN Thursday 9/3 in two mixed-region rooms of five (format changed from pair-first), Brian and Mike moderating simultaneously, and it produced ruled decisions plus six credited best practices. That is 1 of the 2 roundtables Green requires. Yellow is for the other half: zero regional event dates are locked across 5 regions against a 10/19 bar. This week's deliverable is pushing the manager event suggestions out and collecting event confirmation + head count. Brian's read: this goes green if events lock going into next week.",
          ...
          "ruled": {
            ...
            "awaiting": "Vera",
            "record": "brian-goal-change-2026-09-17.json"
          }
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/17 1:1: Jake Petersen offered (S. Austin FM) — Brian + Chris Anderson interviewed, Cameron blessed it in the room. Loop still to close with Izzy and Elijah. The remaining piece is C-player action plans: Brian has been spot-coaching informally (Lukas redirects; Garrison now 105% to goal and leading Einstein Games unprompted) but nothing is written. Ruled next week: run People Analyzer results through Vera, log actions already taken on Lukas and Garrison, action plan built and in review = GREEN. Moving a C to a B = SUPER GREEN. Brian could not find his People Analyzer access — Cameron owes him that. PRIOR — via Vera 9/15: was green/4/92 -> green/4/94 at 49.5% of the quarter elapsed (45 of 91 days). The interview round is no longer pending, it is booked: all three finalists were invited 9/14 with Google Meet links, and Jake Petersen sits Wednesday 9/16 at 11:00 AM. Weighted standings hold at Petersen 89.5, Serrano 86.7, Rasberry 83.6, with the cut recorded on the scorecard (8 -> 7 -> 5 -> 3). Project 4 typing is recorded and deliberately left OUT of the weighted total. Scorecard is at v12 and now confirms its own saves rather than failing silently. RULED 9/15 (Brian): Rasberry's On-Site Evaluation category stays BLANK and unscored - Fort Worth has no FM, so no evals will ever be logged, and the absence is structural rather than a candidate failing. He is ranked across his three remaining categories. Note for the record: this drops his single weakest signal (a lone 41) while Petersen and Serrano both carry real on-site scores on the same 30-weight category. Remaining work is the interviews themselves.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "9/17: ruled Yellow in Brian 1:1 on the Einstein Meeting OS (awaiting Vera). 9/16 huddle (Cameron): biggest Training Camp movement yet; Brian pushing managers directly. 9/15 (Brian): three managers reported three numbers for the same metric, measurement fix needed before grading. via Vera 9/15: was green/4/75 -> RED/2/45 at 40.7% of the quarter elapsed (37 of 91 days), Brian's own call. Green requires >=70% of enrolled movers through stage 4 by 10/31. Actual stage-4 completion by branch against a 16% company-wide figure: Houston 40.6% (reconciled 9/15), San Antonio 19%, North Austin 13%, South Austin 13%, Leander 10% - the four non-Houston figures are the 9/7 read and have not been re-pulled. Three of five branches sit BELOW company. Against a 70% bar that is out of reach without intervention, so the color is red regardless of activity - the prior 75% percent-complete reflected the sandbox and enrollment milestones (both closed) and masked the fact that the binding milestone has barely moved. Intervention is live, not pending: updated messaging and rules go out TODAY off last week's BM session to clear the obstacles slowing signatures and speed-to-competency through stage 4, and the 9/4 retraining ruling removed Stages 2 and 3 as requirements so managers stop re-doing sign-offs with tenured movers. Brian is also working the Training Camp view to drive focus onto red team members and lift engagement region-wide. Stage 4 has been opened to everyone. 9/15 update: Brian worked the managers directly on the app and communicated expectations, and the Houston QG reads surfaced a measurement problem that has to be fixed before the number can be trusted - Sergio reported 40.6%, Alex 26% and Joel 26% for the SAME branch metric in the same week. RECONCILED 9/15 (Brian): 40.6% is the right number - Sergio had it, Alex and Joel were both reporting low. So Houston is materially further along than the 9/7 read showed (26% -> 40.6%) and is now roughly 2.5x the company figure. The rock is Red either way with roughly five weeks to the 10/19 bar.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "9/17 1:1: still 10% with roughly six weeks left. San Antonio slipped on a miscommunication with Dustin (he is off Friday). Brian is in Austin next Friday and thinks he can clear San Antonio and South Austin next week — on-site makes the scorecard audit, circle-up and huddle audit fall out together. The 'redesigned' evaluation dashboard is actually a first design; today it is a Drive spreadsheet managers see once a quarter. RULED in the room: a branch-visit score is a COACHING tool and should NOT carry into the branch scorecard — the branch score is the byproduct of doing things the right way, so the audit just checks that you are. Brainstorm on what the score looks like by end of next week. PRIOR — 9/17: status set from Vera's 9/15 file on Cameron's ruling (the dashboard had held the 9/1 sync read). via Vera 8/31: was yellow/3/0 -> green/3/10 at 40.7% of the quarter elapsed (37 of 91 days). The status changed because the thing that was missing is now in place: a visit schedule. San Antonio 9/18, South Austin 9/25, North Austin 9/30, Leander tentatively 10/15, Houston still to be dated. That is three firm dates ahead of the 10/19 bar, and Green requires 3 of 5 locations - so this is tracking to clear rather than at risk. No movement this week, which is a short week (PTO Thursday and Friday), not a drift. Percent-complete stays low and honest: nothing has been conducted yet.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "9/17 1:1: all CTXH certified. DFW out and in progress — Shane, Eric, Zach and Kevin to finish by end of week, which is the Green line. Grant Hardison 54/60 first attempt off a 29 baseline. Houston's first live main-board read 50/60 (Sergio 54, Alex 54, Joel 52), all 18 QG pulses updated the same day. Brian is confident enough to hand Scrum certification to Jake on day one. Super Green as written included the CX team — Cameron called that a stretch and said land Green first. Possible tie-in: a Scrum cert + board check built into the Meeting OS, alongside Anne/Jalissa and Amanda/Tet running the same 1:1 format. PRIOR — via Vera 9/15: was green/4/80 -> green/4/82 at 49.5% of the quarter elapsed (45 of 91 days). The DFW wave has started producing certifications: Grant Hardison certified 9/15 at 54 of 60 (90%, an A) on his first attempt, off a 29 baseline - a 25-point improvement, valid through 3/15/2027. Houston also got its first LIVE main-board read (as opposed to mock): 50 of 60, a B, qualifying - Sergio 54, Alex 54, Joel 52, all three clearing. The standout there is that all 18 quarterly goal pulses across three managers were updated the same day, the strongest QG discipline on record across any board read. Green still requires all 10 branch boards re-certified by 10/19, and nine of ten DFW boards remain untouched.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "red",
          "assessment": "9/17 BM roundtable: six branches 50%+ across the line at 120 signatures. Mike denied 150 photos in one day of auditing and caught a mover submitting photos of photos. BMs voted to unlock delayed uploads (live same day, beta) because live-photo-only was the top mover complaint and denied photos are the #1 morale hit; Mike opposed it on integrity grounds and shipped it anyway on the vote. 3/day limit returns post-quarter. Lead PIN approval + lead-training dashboard deferred to Q4. PRIOR — 9/16 huddle (Cameron): biggest Training Camp movement yet after the latest training days; new quick audit process catches gaming; BM warnings due Fri 9/18. via Gerald 9/14: Red but trending green — best week of the rollout. Off BM feedback about what was blocking their teams, Mike shipped a batch of app updates (all live now) and sent every manager the changes plus a hard expectation: each branch keeps more than 50% of its movers engaged (on track OR at risk), deadline EOW. It moved the needle — behind dropped 181 to 147 and company engagement is 44% (41 on track, 79 at risk, 147 behind, 4 not started of ~271). Over the 50% line already: San Antonio 81%, Tampa 78%, Fort Worth 69%, Leander 59%, Garland 58%. Under it and where the EOW push has to land: South Austin 21%, North Austin 30%, Dallas 36%, Houston 39%, McKinney 41%. Still Red on the 70%-through-pipeline gate, but for the first time there is a real lever (shipped fixes + a branch-level hard line) and the trend is the right direction.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "9/16 (Amanda in class): grader running and on the hub; scores did NOT improve week over week — reps not consistently asking the concern question at the start. Weekly numbers were not reviewed at the top of class as planned. via Gary 9/7: Yellow — a methodology pivot, not just a delay. Grading has gone through several structural iterations over the last two weeks as leadership went through Jeff's (Northwood) training. Now restructuring around the three-stage framework Jeff walked leadership through on 9/3: every rep gets a baseline score captured before training, and the next scoring round measures them against their own baseline rather than a flat company average. Company average still sits at 45.8 cumulative against the 65 Green bar — no new score data since 8/17 — but the coaching frame is shifting to self-improvement. Phone-join plumbing and the rubric calibration session are still pending on top of this.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "via Gary 9/7: Yellow — focus group named, but still early and unproven. Prior plan (broad reporting to everyone) hit a roadblock; new plan is concrete: focus manual review on the bottom performers, get feedback on specific over/under estimates, correct root-cause assumptions (managers run conservative on large homes, underestimate apartments — both fear of a bad big-move experience). Focus group is now named — Danah, Erik, and Jespah — on the theory that their lower sales numbers may trace back to estimating accuracy. Still a delayed-result metric — this plan won't move the accuracy number for 2-4+ weeks, and the review work with this group hasn't started yet. Bars confirmed 8/17 as written on the chart (46% Green / 48% Super Green).",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Matisen 9/18: Hub deployment to the team is the live thread: the runner and builder are moving off Matisen's local machine into the cloud, with team deployment targeted Mon-Tue 9/21-22 — in flight, not shipped. B: the LiftUp line-by-line ran 9/15 and the ruling holds at no rewrite and no new datastore, repoint reads to the existing secondaries. A is unchanged: region scorecards are built but still not delivered. D (Sage) is paused as of 9/11 until the Rippling kiosk punch conflicts are resolved.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Matisen 9/18: D: the ESP RO pilot went live 9/10 (manual mode with Amanda for a couple of weeks before automation triggers); the chatbot launch email is drafted and waiting on approval for the LeadFerno sunset. The AI call system (Evoca) was deferred 9/11 to October with Matisen and Amanda owning the selection. B unchanged: call grading runs nightly, estimate_accuracy live on the hub; conversion on the sales target dashboard still to do. Paused for the week of 9/15 to focus on the Rippling timeclock bugs and closing out the hub; ESP scenario 12 (move date passed, created inactive, 22-lead preview) and the 9/15-16 advance-button outage recovery landed before the pause.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "via Matisen 9/18: B: the promotion-eligibility tool moved to hours-based windows on 9/11; Paul and Anne lock thresholds this week and present to Cameron for buy-in before rollout messaging. C: 160+ Rippling kiosk punch conflicts remain open with Rippling; the Jamf path to push the update to every device was found 9/10 and the kiosk bug form is taking mover reports. A: webhook verification still not reported done. Week of 9/15: C is the only block running — Rippling timeclock/kiosk bugs are the focus (9/17 kiosk name audit, branch-vs-truck purity, Timeclock 5.0.10 OS floor, Jamf push path). A, B and D are paused this week.",
          "superGreen": "100% Green or higher (4 of 4)",
          "green": "75% Green or higher (3 of 4)",
          "sourceUpdated": "2026-09-18",
          "source": "cos-feed",
        ...
        },
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "via Matisen 9/18: 12 of 48 praise delivered and logged to the Praise Board as of 9/18 (board-verified: 5 on 9/07, 2 on 9/09, 4 on 9/11, 1 undated), with 2 more sitting Not Delivered in the Manager Queue. Nothing new logged since 9/11. Logging goes straight to the board by API the same day the praise is given. Burn-down: 36 to Green in about 6 weeks, roughly 6 a week.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "assessment": "9/9 sync: GREEN. Jorge A (repeat customer) filmed, edited and published — the primary subject went dark and he worked his backup list rather than stalling. Needs 2 for green, 3+ for SG; hunting another repeat customer next week. The two-movers-for-an-hour incentive is doing real work.",
