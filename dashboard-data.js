const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-08-19T13:30:00-05:00",
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": false,
      "status": "unknown",
      "assessment": "8/19 huddle: Matisen has Einstein Games fully automated → Data Hub bundle → QGR packet + branch/company scorecards targeted live by Fri 8/21 (validation pending) — first automated feed into the packet family. Hub gated to Einstein + KP vendor emails (Jeff added). Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
