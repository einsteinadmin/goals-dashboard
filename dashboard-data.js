const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-06-18T10:45:00-05:00",
    "refreshedBy": "Albert (digest — 6/18 huddle)",
    "archive": {
      "quarter": "Q1 2026",
  ...
  "network": {
    ...
    "lastRefreshed": "2026-06-03T17:40:00-05:00",
    "matrixUrl": "https://einsteinadmin.github.io/einstein-cos-matrix-059563b8c478/",
    "agentsReporting": 1,
    "agentsTotal": 6,
    "adoptionPct": null,
    "adoptionLabel": "Awaiting pilots",
    "staleCount": 0,
    "pendingTotal": 0,
    "summary": "Albert is the truth source. Pilot trio (Gerald/Clark/CoS-MH1) onboards next — then the adoption % becomes real."
  },
  ...
  "cameronRocks": [
    {
      ...
      "critical": true,
      "status": "green",
      "assessment": "Cameron's personal Q2 thesis. 5 of 6 COS active (Albert, Gerald-Mike, Matisen's, Clark-Paul, Vera-Brian). 5/29: Amanda + Anne workspace repos (cos-amanda, cos-anne) created + seeded + invited — Amanda onboarding in flight, Anne queued; naming standard locked to cos-<principal>. Critical # = 6 active COS with weekly usage; Amanda is #6. Network governance maturing: repo consolidated to one private template, github-pages-publishing + stub-prompt patterns pushed via SCB and acknowledged by Gerald/Clark/Vera. Three legs: (1) MCP config generator HTML form, (2) synthesis pipelines as scheduled Claude Code Routines (shipped 4/14), (3) Dojo = renamed skills repo + /dojo recommender skill.",
    ...
    },
    {
      ...
      "critical": true,
      "status": "green",
      "assessment": "Co-owned with Matisen R1. Cameron oversight; Matisen execution. Audit complete by 5/15 (SG) or 5/30 (G). 7+ supporting QG dependencies go Green by EOQ for SG, 5+ for G. 6/12: 2 of 3 wedges moving — sales-call grading pipeline live (2 calls/wk x 33 reps) + applicant-pipeline dashboard w/ cost-per-hire in data-validation phase; third wedge = damages/reviews auto-populate into EMMA.",
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "6/17 KP launch conversation: homepage animation DIRECTION LOCKED — full continuous 'Mover Journey' desktop design (Cameron's v1 pick), accepting reduced flexibility (components must be decided pre-build; copy edits in-house, structural changes need a dev; Einstein owns the repo). One open dev Q to Rich: can the animation split at an 'elevator seam' to insert cards / extend pages without a rebuild (preserve appeal + some flexibility). SEO/LLM covered (keep a locations component + differentiators; grounding queries = awards/reputation/insured, already on site). 🔴 GATING NEXT = Cameron reviews KP's 5-page .md feedback + locks homepage components -> unblocks Emma's next sprint. Quote funnel reconciled (Option 2; Jeff builds staging front-end). Handoff: website-workshop/launch-handoff-2026-06-17.md. | Prior 6/15: mover-journey shown to leadership.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "yellow",
          "assessment": "6/15: trending RED — CTXH region avg now 6.8 (target 7.0); N. Austin (~5.8) + San Antonio the laggards. Onsite coaching (NA, Leander → S. Austin, Houston); teaching Vera to help coach + keep pace. Contract-efficiency manual-review lag frustrating teams.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": false,
          "status": "supergreen",
          "assessment": "6/15: → SUPER GREEN — past scaffold to a FUNCTIONAL app (role-based signature assignment + backend tracking dashboard). DoD: integrate Austin's videos + AI-formatted text, functional beta by EOW. Cameron endorsed building the Super Mover app on this platform.",
