const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-05-18T09:30:00-05:00",
    "refreshedBy": "Albert (Monday /retro refresh)",
    "archive": {
      "quarter": "Q1 2026",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "Jack Davis Garland BM (transition complete). Landon → N. Dallas Ops Mgr under Beattie. Terrel staying under Mike, expanded flex/ops scope. Stephen Anderson onboarding at Tampa as OM. Stephen+Shane bounced back to 110% hiring goal in 1 week after losing 2 leads. Scaling Tampa to 5 trucks.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "Dallas safety training validated 5/14 — Samsara score 11 vs high 80s/90s elsewhere via Mike's revised 1-hr deep-dive with video review + alerts breakdown. Framework working. Garland next. Samsara consolidation EOQ.",
