const DASHBOARD_DATA = {
 "meta": {
  ...
  "lastRefreshed": "2026-09-04T11:15:00-05:00",
  ...
  "statusHistoryStamped": "2026-09-04"
 },
 "network": {
  "phase": "1",
  "phaseLabel": "All 7 COS live — Q3 tracking opens",
  "lastRefreshed": "2026-09-04",
 ...
 "cameronRocks": [
  {
   ...
   "critical": false,
   "status": "unknown",
   "assessment": "9/3 watch on Lane 2 (CER call-grading trial from 9/1, >60 avg): the grading rubric is being REBUILT to mirror Jeff's 3-stage map (Amanda, target Tue 9/8) and the old Q3 call-grading incentive is paused for the Trinity rollout — the >60 bar was written against the old rubric; re-baseline the bar once the new rubric grades its first week. | 8/19: Trinity sales class #1 ran 8/18 (class #2 today); Wimp Junction role-play trainer live on Replit v1.1, publish+share to Amanda today; ITP color-code round moved to Fri 8/21. Q3 slate ratified in the room at the 7/29–30 Roundtable QGR. Quarter opens 8/1 — no execution data yet; status fills in as the COS feed pushes.",
  ...
  },
  {
   ...
   "critical": false,
   "status": "green",
   "assessment": "9/3 — FOUR Trinity sessions digested (pre-call · Amanda debrief · 12:30 Sales Leadership Training · check-in). Jeff unveiled the 3-stage SALES MAP (Listen to earn trust → Present only what they want → Lock in / price; 7 new statements) + a 4-week program: classes RESUME Tue/Wed 9/8–9/9 12:30, homework before every class (wk 1 = quid pro quo + agenda question memorized), homework reviewed at open. RUBRIC direction ruled in-room: mirrors the 3 stages, stage 1 weighted 80–85% for month one; two numbers per cohort every class = rubric score + conversion (Amanda grading last week's calls for baselines; Matisen owes the conversion cut by Tue 9/8). 'Not optional' posture locked + carrots (weekly rewards, first 2–4 wks). Disqualifiers move up front. Amanda's finding: calls are being COMPRESSED not lengthened — stage 3 fine print (10–15 min) is why reps rush stage 1; Jeff reviewing the pricing script to shave it. Watch: Jeff↔Amanda communication gap + call-length × conversion vs spring capacity. Green holds — rubric + cohorts + reporting all have dates inside next week; flips to yellow if the 9/8 numbers don't exist. | 8/28 PROMOTED BONUS → ROCK #5 and BARS REWRITTEN (both Cameron-approved). The carried-over bonus bars were already substantially met — \"engagement kicked off + playbook delivered\" both happened in August — which would have made this an auto-Green with two months left. New bars measure the REMAINING Q3 scope: rubric built and in use, cohorts actually running, per-rep reporting live. SG keeps the lead-triage/EMMA plan, the one piece genuinely still ahead. Live state: five moves locked with weights · call flow CONFIRMED by Jeff 8/27 · roleplay app v1.8 in trial with Nhel + Tet · abbreviated class w/ Jeff Thu 9/3 12:30 to build the rubric · cohorts resume ~wk of 9/8 · weekly conversion reporting pulsed to Amanda + Matisen. ⚠ Distinct from Amanda Ware's Rock #6, which grades the OUTCOME (close rate +2/+3.5 pts off the frozen 8/5 baseline). This is the sponsor/architect lane.",
  ...
  },
  {
   ...
   "goals": [
    ...
    },
    {
     ...
     "critical": false,
     "status": "green",
     "assessment": "9/1 sync: G 90% — all projects in by Wed, graded by EOW, interview picks possibly Fri. Missing-category scoring deliberately PAUSED — Brian works a lean with Vera and brings it to Cameron (not ruled). Root cause of eval gaps: old onsite board deleted in the FM Super Board build (thousands of evals lost). Rance delegated the onsite-distribution plan.",
    ...
    },
    {
     ...
     "critical": true,
     "status": "green",
     "assessment": "9/1 sync: G — Mike+Brian split the handbook auditing Wed (Brian audits DFW, Mike SCTX); dashboard read still fuzzy (date-range bug fixed 9/1) — Mike walks the team through it at Wed's huddle (parking-lotted). Company adoption reality from Mike's side: 42/288 movers on pace. Automation seed: Vera to explore photo-audit RAG classifier.",
    ...
    },
    {
     ...
     "critical": true,
     "status": "green",
     "assessment": "9/1 sync: G — 8 of 15 CTX managers certified (scores 87–97, Alex top); deadline extended to ALL 15 by EOW, then DFW boards, then claims/Jalissa/Austin. Mock-board grades wash out at certification → official weekly scorecard cadence starts clean. Zero micromanage pushback.",
  ...
  },
  {
   ...
   "goals": [
    ...
    },
    {
     ...
     "critical": false,
     "status": "green",
     "assessment": "via Gary 8/31: Green — a real methodology unlock today (8/31 O3), not just more waiting. Prior plan (broad reporting to everyone) hit a roadblock; new plan is concrete: focus manual review on the bottom-4 performers, get feedback on specific over/under estimates, correct root-cause assumptions (managers run conservative on large homes, underestimate apartments — both fear of a bad big-move experience). This week's green goal is getting regular weekly/biweekly reporting out to reps (not currently shared at all) plus naming the bottom-4 focus group. Still a delayed-result metric — this plan won't move the accuracy number for 2-4+ weeks. Bars confirmed 8/17 as written on the chart (46% Green / 48% Super Green).",
