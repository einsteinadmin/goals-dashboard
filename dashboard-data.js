const DASHBOARD_DATA = {
 "meta": {
  ...
  "lastRefreshed": "2026-08-25T12:15:00-05:00",
   ...
   "goals": [
    {
     ...
     "critical": false,
     "status": "unknown",
     "assessment": "⚠ External partner — Q3 goals get set at the Paul+Ben goal-setting session Thu 8/27 2:30 CT. 8/25 state: closed the $298K Q2 NOI residual same day back from vacation (full memo + line-level BvA; cover grade unblocked); CFO dashboard moving to QTD-vs-target layout + per-BM restricted Cloudflare views this week; bonuses to a gated tab (Ben/Paul/Cameron only).",
     "superGreen": "",
     "green": "",
