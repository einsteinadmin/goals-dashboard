    ...
    },
    {
      ...
      "numbers": [
        ...
        },
        {
          ...
          "actual": "March: 37% conv, 107% to goal",
          "status": "green",
          "note": "March: 107% to goal, $37% conversion. Daniel ~200%, Zach 123%. Branch: SA 138%, MCK 135%, FW 123%, GAR 115%, NA 101%, S. Austin 97%, Leander lagging. April budgets confirmed."
        }
      ]
    },
    {
      ...
      "numbers": [
        {
          ...
          "status": "green",
          "note": "Option A confirmed (4/7). EMMA wild quotes RESOLVED — per-floor multiplier issue, temp fix 1.5x in place. VP training: Amanda working on it 4/8 with Nhel, hoping EOD, target readiness Monday. Mike sent mover announcement prematurely — redirected. Day-of-week rollout still gated on Amanda training. Amanda out 4/11-4/17. Site-wide static pricing audit in progress (KP). Email quote redesign underway (Amanda mockups, Matisen tech, KP design). Quote form Google Ads tracking broken — Matisen + Jeff fixing. Phase 2: location-specific tuning + weekly review cadence."
        },
        {
