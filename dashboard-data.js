      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/18: company-wide Einstein Games score up to 8.8; Brian also shipped a working Mentimeter-replacement Replit app (Cameron reviewed + praised) and rallied the late-week lead-clear surge. CTXH still the region to watch (6/15 region avg ~6.8, N. Austin/San Antonio laggards) — onsite coaching continuing + teaching Vera to help coach. Company number strong; CTXH-specific 7+ floor is the open item.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "red",
          "assessment": "6/15: still Red but recovering fast — 96% through May/June, big jumps, trending toward overstaffed; strong on revenue budgets. People Analyzer still the lagging piece. Paul directive: hire to open trucks (budget not the blocker).",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: running the scorecard himself; DoD = teach Vera to run it (asked whether Albert can help pre-grade). Wants to package it for others.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: San done last week; N. Austin Wed + Leander Thu → Green after this week.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "6/15: trending toward green — app posting July company-wide for general agenda; still no TD station links/slides built.",
        ...
        },
        {
          ...
          "green": "Read by 5/30",
          "assessment": "6/15: → Super Green — done with section 3, starting section 4 this week."
        }
      ]
    },
    {
