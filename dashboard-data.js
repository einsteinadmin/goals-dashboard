const DASHBOARD_DATA = {
  "meta": {
    ...
    "lastRefreshed": "2026-04-10T10:30:00-05:00",
    "refreshedBy": "Albert (digest — 4/10 huddle)"
  },
      ...
      "numbers": [
        {
          ...
          "status": "green",
          "note": "⚠️ RED FLAG 4/10: Multi-day VP features have REGRESSED in production after being QA-verified at rollout. Active price variable was deleted from code — customers got auto-updated to May pricing. Bobby pushing fix 4/10. Matisen investigating git tree root cause on Bobby's local machine. Revert list ready for affected customers. Could pressure Tuesday 4/14 go-live if not resolved. 3-month auto-booking bug patched (window extended to 365 days, not root fix). Day-of-week rollout training launched 4/9 — all BMs walked through, everyone trained by Monday. Pricing changes push Monday night → live Tuesday. Price sheet finalized (Brian). Quote form Google Ads tracking broken (Matisen + Jeff fixing Monday)."
        },
        {
      ...
      "numbers": [
        {
          ...
          "actual": "ON HOLD",
          "status": "red",
          "note": "Migration paused. Prosper VCFO confirmed. Joselle + Mike S finance transition Friday 4/11. If Prosper chosen path = Sage Intacct. Will be Red at EOQ — no migration this quarter."
        },
        {
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": true,
      "status": "green",
      "assessment": "Variable Pricing Phase 1 LIVE (3/30). Option A confirmed (4/7). EMMA wild quotes RESOLVED — per-floor multiplier issue, temp fix 1.5x in place. VP training: Amanda working on it today (4/8) with Nhel, hoping EOD, target readiness Monday. Mike sent mover announcement prematurely — Cameron redirected, gated on Amanda training completion. Amanda out Friday 4/11 through potentially Thursday 4/17. Site-wide static pricing audit in progress (KP). Email quote redesign underway — Amanda mockups done, Matisen building tech, KP finalizing design. Quote form Google Ads tracking broken — Matisen + Jeff fixing.",
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "Awards page LIVE. Mailers DONE all cities (QR + tracking live). Billboards April 6. Marketing dashboard DONE with walkthrough + FAQ. Design system proposal coming EOD/EOW from Laura. ROAS mapping still the Super Green blocker.",
  ...
  "leadership": [
    ...
    },
    {
      ...
      "goals": [
        { "name": "Fleet Safety", "critical": true, "status": "supergreen", "assessment": "DFWT branches crushing it (Dallas 96, Tampa 100). Training complete. Weekly accountability strong. Idling reduction rollout starting.", "superGreen": "80+ avg, <10% at-risk, weekly dashboard, monthly BM meetings, accountability during sync ups", "green": "All trained by March 31, 75+ avg, <20% below 70" },
        ...
        { "name": "Regional Growth (Tampa/Garland OMs)", "critical": false, "status": "green", "assessment": "Tampa OM: Stephen Anderson onboarding in progress. Garland manager hiring opening — posting internally + externally. Dom incident being processed. Grant morning sales block initiative.", "superGreen": "OM hired and trained for Tampa AND Garland", "green": "OM hired and trained for Tampa" },
    ...
    },
    {
      ...
      "goals": [
        ...
        { "name": "Evaluate CFO Needs/Budget", "critical": false, "status": "green", "assessment": "Prosper VCFO confirmed. Joselle + Mike S finance transition Friday 4/11. Paul out April 15-17 (brother's surgery). ROAS review pushed to next week — controllers verifying revenue numbers. Green — decision made, execution underway." }
      ]
    },
    {
