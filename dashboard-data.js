const DASHBOARD_DATA = {
 "meta": {
  ...
  "lastRefreshed": "2026-08-28T16:10:00-05:00",
  "refreshedBy": "Albert (/retro — rock swap)",
  "archive": {
   "quarter": "Q2 2026",
  ...
  "statusHistoryStamped": "2026-08-28"
 },
 "network": {
  "phase": "1",
 ...
 "cameronKPIs": [
  {
   ...
   "target": "66%",
   "actual": "8/28 hub (pulled 8/27 AM run; today's full run pending): running-truck base 39.5% (Aug MTD) · trailing-active QTD 84.4%",
   "status": "unknown",
  ...
  },
  {
   ...
   "target": "20%",
   "actual": "8/28 hub (pulled 8/27 AM run; today's full run pending): Conversion $ (slide-back) 23.7% vs 20% target — Green",
   "status": "green",
  ...
  },
  {
   "name": "Customer NPS",
   "target": "90+",
   "actual": "8/28 hub (pulled 8/27 AM run; today's full run pending): Aug NPS 86.4 (GatherUp direct, pulled 8/24) — below 90 = Red on binary ruling",
   "status": "red",
 ...
 "cameronRocks": [
  ...
  },
  {
   ...
   "critical": false,
   "status": "green",
   "assessment": "8/28 ⭐ PROMOTED FROM BONUS → ROCK #5 (Cameron). One-for-one swap: Manager Ongoing Education Library moves down to the bonus slot. His reason: \"work on the sales has become huge time commitment (should be own goal).\" What it grew into since the 7/31 scoping meeting: ~$54.5K 12-week Trinity engagement · five moves locked with weights (Quid Pro Quo 35 / Get Their Agenda 35 / Dig Deeper 10 / Actively Listen 10 / Ramp-Up Takeaway 10) · call flow CONFIRMED by Jeff 8/27 · roleplay trainer app v1.8 live and in trial with Nhel + Tet · rubric build unblocked and owned by Amanda · abbreviated class w/ Jeff Thu 9/3 12:30 to build the rubric · cohorts resume ~wk of 9/8 (CET first, 6-7 per cohort) · weekly per-rep net-new conversion reporting pulsed to Amanda + Matisen. ⚠ BARS CARRIED OVER FROM THE BONUS SLOT AND ARE NOW STALE — the Green bar is substantially met already, which would make this an auto-Green. Refreshed bars owed from Cameron. ⚠ Distinct from Amanda Ware's Rock #6, which grades the OUTCOME (net-new close rate +2pts Green / +3.5pts SG off the frozen 8/5 baseline). This row is the sponsor/architect lane so one engagement isn't graded twice.",
   "superGreen": "Green + lead-triage recommendation converted into an actionable EMMA implementation plan with Matisen",
   "green": "Engagement kicked off + Sales Playbook delivered + Amanda's Sales Management Operating Plan stood up on the weekly cadence",
   "lastUpdated": "2026-08-28",
   "statusSince": "2026-08-28",
   "statusDays": 0
  }
