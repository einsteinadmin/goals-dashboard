const DASHBOARD_DATA = {
  ...
  "cameronRocks": [
    ...
    },
    {
      ...
      "critical": false,
      "status": "green",
      "assessment": "6/24 KP sync — DIRECTION PIVOT: killing the complex multi-floor homepage animation (the Mover Journey scroll). Cameron couldn't make an elevator component work + adding stairwells = more tax than benefit; Rich (KP dev) confirmed a v2 edit wouldn't reduce the rigidity much. Moving to the BRAND-STORY homepage (KP/Emma's favored mockup) — keeps the site flexible (movable components, FAQ + service-area blocks, changeable banner) with smaller animation/joy elements instead of the multi-page stroll. Content approach: fuse the moving-nightmare pain points WITH the Smart Move System answers (nightmare as the heading, the smart-X feature as the answer beneath, scannable + visuals) rather than separating them; Amanda floated a Smart Move System timeline/product visual. Next: Cameron builds out the 5 key pages (fidelity, brand-story) by ~7/6 using Emma's components; KP reviews when back (closed 6/29-7/3); Cameron out Mon-Wed next wk, back Thu/Fri. Supersedes the 6/18 ship-v1-animated-journey audit conclusion. | Prior 6/18: 7-critic audit -> ship v1, fix CTA blocker; v2 Peekaboo built.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": true,
          "status": "red",
          "assessment": "6/23: Holding Red — no status change. All branches at 100%+: N. Austin 53.1% budget / 109% to goal, S. Austin 111%, Leander 100%, San Antonio 107%, Houston 101%. Holding steady last two cycles. Will need strong July to offset May misses in Leander + S. Austin. People Analyzer still the lagging piece (not discussed as progressed).",
        ...
        },
        {
          ...
          "critical": false,
          "status": "yellow",
          "assessment": "6/23: Still Yellow — deprioritized again due to Calvin transition + schedule week. Brian estimates he can get it to Green in ~1 hr of focused time. Committed to carving out time this week (it's in 'This Week' on his board), but posting BM applications + manager schedules takes priority. Cameron coaching: appropriate triage is the goal, not 100% completion — no stress if it slips to next week.",
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/15: ClearCo dashboard in progress; endpoints → make.com → ClearCo webhooks this week (automates onboarding via a Rippling queue). Stuck: how to capture hiring ad spend (Indeed-only) — needs Anne. On pace for green.",
        ...
        },
        {
          ...
          "critical": true,
          "status": "supergreen",
          "assessment": "6/15: Super Green. Gap analysis runs the morning after contracts close (ClearCo linkage pending but not blocking). Capacity→pricing model maturing; 4-week TUR/capacity-gap analysis next; package tool w/ TUR + rate settings + a cross-functional playbook.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: Amanda's side has traction (first run done). Claims RAG paused; primary output now = auto-pull Google reviews into EMMA (offload Jaci) — demo this week, reviews pulling by EOW.",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: ClearCo dashboard build continues; endpoints → webhooks; hiring-spend capture is the open question (needs Anne).",
        ...
        },
        {
          ...
          "critical": false,
          "status": "green",
          "assessment": "6/15: Denis engagement closed; code review + API keys w/ Fabian, ship this week. Relocation trend maps, service zone maps, Rippling sync (PL→Rippling) + workflow template (auto-create a Monday pulse on new hire).",
        ...
        },
        {
          ...
          "superGreen": "Read by EOQ + 1-page reflection on personal H/H/S gaps",
          "green": "Read by 5/30",
          "assessment": "6/15: finish book + one-pager this week. Super Green."
        }
      ]
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "assessment": "6/23: Still stalled. Schedule w/ Paul week of 6/29 once bandwidth opens post N. Austin office move. Needs comp philosophy locked first."
        },
        {
      ...
      "goals": [
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/23: Grading engine live; calibration (15-call spot-check) still pending. DoD this week: huddle w/ Nhel on the call-grading distribution plan (weekly/monthly). May company-wide $ conversions 80.78% (Red floor) = the real lever to watch.",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "critical": true,
          "status": "green",
          "assessment": "6/24: PIVOT to the brand-story homepage — Cameron killed the complex multi-floor animation (couldn't make the elevator component work; Rich confirmed v2 stays rigid). Brand-story keeps the site flexible w/ lighter animation; content fuses moving-nightmare pain points with Smart Move System answers (scannable, visuals). Cameron builds the 5 key pages (brand-story fidelity) by ~7/6 on Emma's components; KP reviews when back. KP closed 6/29-7/3 (Laura back the week after, Elizabeth out next wk). No urgency — Cameron ahead of schedule.",
