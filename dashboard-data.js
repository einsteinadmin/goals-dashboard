const DASHBOARD_DATA = {
 "meta": {
  ...
  "lastRefreshed": "2026-08-28T13:15:00-05:00",
  "refreshedBy": "Albert (/gm \u2014 Q3 goal ratification)",
  "archive": {
   "quarter": "Q2 2026",
  ...
  },
  {
   ...
   "goals": [
    ...
    },
    {
     ...
     "critical": true,
     "status": "yellow",
     "assessment": "via Linda 8/27: \u26a0\ufe0f 8/26 correction (Cameron + Anne): the goal was misread earlier the same day \u2014 what got built and shared with the other 6 Roundtable leaders' COS agents (a manager-to-own-direct-reports weekly checklist) was NOT the actual design; retracted same day. \u2705 8/27 (huddle + Cameron 1:1): mechanism fully redesigned and locked. Every 2 weeks, each of the 7 Roundtable leaders calls anyone below them company-wide (deliberately cross-functional/cross-geography once comfortable; own-division fine at first) for a 5-minute start/stop/keep \u2014 no scheduling coordination, just find whoever's available. No manual assignment of who-talks-to-whom. Logged via a lightweight Replit submission app (not yet built) that tracks completion (who's done, who's missing) without adding admin work for the leaders. Immediate fires (safety, harassment) get triaged same-week; broader themes are digested quarterly \u2014 data collected through end of September, synthesized in October, folded into Q4 branch-level goals. Cameron explicitly said not to assume there will be themes \u2014 full adoption + honest tracking counts as success on its own, not a themes-found metric.",
     "superGreen": "Green + full participation tracked with no missed leaders across a full quarter, and at least one theme identified and routed to the Q4 branch-goal digestion process.",
     "green": "Practice designed and documented (5-minute call every 2 weeks, random employee company-wide, logged via a lightweight submission app), adopted by all 7 Roundtable leaders, by September 15.",
     "sourceUpdated": "2026-08-27",
     "source": "cos-feed",
     "pulse": "11728350964",
